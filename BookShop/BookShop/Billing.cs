    ...
    public partial class Billing : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                newRow.Cells[1].Value = BTitileTb.Text;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("***********BookStore***********" + Grdtotal, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Crimson, new Point(40, pos + 85));
            BillDGV.Rows.Clear();
            BillDGV.Refresh();
            pos = 100;
            Grdtotal = 0;
        ...
        private void EditBtn_Click(object sender, EventArgs e)
        {
            ...
            if (ClientNameTb.Text == "" || BTitileTb.Text == "")
            {
